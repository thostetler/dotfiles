...
_simple() {
    ...
    curl -sS https://webi.sh/vim-gui | sh
    curl -sS https://webi.sh/vim-devicons | sh
    curl -sS https://webi.sh/vim-commentary | sh
    curl -sS https://webi.sh/vim-airline | sh

    # others
    curl -sS https://webi.sh/trip | sh
    curl -sS https://webi.sh/arc | sh
    curl -sS https://webi.sh/gh | sh
    curl -sS https://webi.sh/jq | sh
    curl -sS https://webi.sh/yq | sh
    curl -sS https://webi.sh/ssh-pubkey | sh
}
